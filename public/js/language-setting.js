var ssb = {
    ...
    scrollbar: function (cont_id) {
        ...
        // adding new container into arshakirray
        ...
        cont.st.onmousedown = function (e) {
            ...
            ssb.mouseY = e.clientY + document.body.scrollTop;
        ...
        cont.ssb_onscroll = function () {
            ...
            this.sb.style.height =
                Math.ceil(Math.max(this.ratio * this.offsetHeight) + 1) + "px";
        };
    ...
    refresh: function () {
        for (var i = 0, N = ssb.N; i < N; i++) {
            ...
            o.ssb_onscroll();
            o.sb.style.height =
                Math.ceil(Math.max(o.ratio * o.offsetHeight) + 1) + "px";
        }
    },
    // arrow scrolling
...
window.onload = function () {
    ssb.scrollbar("scrollParent"); // scrollbar initialization
};
